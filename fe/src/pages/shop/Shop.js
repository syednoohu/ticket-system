...
import { useGetAllShopsQuery } from "../../Redux/features/shopApiSlice";
...
const Shop = () => {
  ...
  const { data, isLoading } = useGetAllShopsQuery(params) || {};
