...
import { useGetAllCompanysQuery } from "../../Redux/features/companyApiSlice";
...
const Company = () => {
  ...
  const { data, isLoading } = useGetAllCompanysQuery(params) || {};
