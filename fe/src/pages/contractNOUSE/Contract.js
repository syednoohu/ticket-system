...
import { useGetAllContractsQuery } from "../../Redux/features/contractApiSliceNOUSE";
...
const Contract = () => {
  ...
  const { data, isLoading } = useGetAllContractsQuery(params);
  ...
  const columns = [
    ...
    },
    {
      ...
      // type: 'actions',
      width: 150,
      renderCell: (params) => <ContractActions {...{ params }} />,
    },
  ];
